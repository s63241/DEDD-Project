...
<h3 class="text-primary prompt-400"><i class="fa fa-bookmark" aria-hidden="true"></i> อัปโหลดรูปภาพโปรไฟล์</h3>
...
<form action="form_upload_img_db.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <input type="submit" class="d-block" name="button" id="button" value="Submit" />
</form>
