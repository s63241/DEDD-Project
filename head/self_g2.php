...
<h4> ชุดที่ 2 </h4>
<form action="self_g2_db.php" method="post" name="ev" class="form-horizontal" id="frm">
        ...
        <table width="100%" border="1" class="table table-hovered">
          ...
          <tr>
            ...
            <td>
              ...
              <input type="number" name="s_score[]" data-id="score" required="required" max="<?php echo $row_rsquint1['q2_score_rank']; ?>"  min="0" class="form-control input" step="0.01"/>
            </td>
          </tr>
