...
<p style="text-align: center;padding:0px;margin:0px;">หน่วยงาน.............</p>
<table width="100%" >
    <tr style="border:none;">
        <td style="border:none;" width="30%">รอบการประเมิน</td>
        <td style="border:none;" width="30%"><input type="checkbox" /> รอบที่ ๑</td>
        <td style="border:none;">๑ ตุลาคม ๒๕๖๐ ถึง ๓๑ มีนาคม ๒๕๖๑</td>
    </tr>
    <tr style="border:none;">
        <td style="border:none;"></td>
        <td style="border:none;"><input type="checkbox" /> รอบที่ ๒</td>
        <td style="border:none;">๑ ตุลาคม ๒๕๖๐ ถึง ๓๑ มีนาคม ๒๕๖๑</td>
    </tr>
</table>
<table width="100%" >
    <tr style="border:none;">
        <td style="border:none;" width="50%">ผู้รับการประเมิน</td>
        <td style="border:none;">ตำแหน่ง</td>
        
    </tr>
    <tr style="border:none;">
        <td style="border:none;">ชื่อผู้ประเมิน</td>
        <td style="border:none;">ตำแหน่ง</td>
