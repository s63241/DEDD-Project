                            ...
                            do {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="number" data-id="score" name="s_score[]" max="<?php echo $row_rsquint1['q3_score_rank']; ?>" min="0" class="form-control input" step="any"/>
                                    </td>
                                </tr>
                            <?php
                            ...
                            do {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="number" data-id="score" name="s_score[]" min="0"  step="any"  max="<?php echo $row_rsquint1['q3_score_rank']; ?>"  class="form-control input" />
